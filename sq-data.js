...
const courses = {
    "l-r": {
        id: "l-r",
        title: "L / R",
        subtitle: "Light or Right?",
        labelJa: "LとRの聞き分け",
        theme: "text-emerald-600", bgTheme: "bg-emerald-50",
        coachA: "l", coachB: "r",
        pairs: [
    ...
    "b-v": {
        id: "b-v",
        title: "B / V",
        subtitle: "Berry or Very?",
        labelJa: "BとVの聞き分け",
        theme: "text-blue-600", bgTheme: "bg-blue-50",
        coachA: "b", coachB: "v",
        pairs: [
    ...
    "s-sh": {
        ...
        subtitle: "See or She?",
        labelJa: "SとSHの聞き分け",
        theme: "text-indigo-600", bgTheme: "bg-indigo-50",
        coachA: "s", coachB: "sh",
        pairs: [
    ...
    "s-th": {
        id: "s-th",
        title: "S / TH",
        subtitle: "Sink or Think?",
        labelJa: "Sと無声音TH",
        theme: "text-teal-600", bgTheme: "bg-teal-50",
        coachA: "s", coachB: "th_s",
        pairs: [
    ...
    "th-z": {
        id: "th-z",
        title: "TH / Z",
        subtitle: "Breathe or Breeze?",
        labelJa: "有声音THとZ",
        theme: "text-emerald-500", bgTheme: "bg-emerald-50",
        coachA: "th_z", coachB: "z",
        pairs: [
    ...
    "f-h": {
        id: "f-h",
        title: "F / H",
        subtitle: "Food or Hood?",
        labelJa: "FとHの聞き分け",
        theme: "text-amber-600", bgTheme: "bg-amber-50",
        coachA: "f", coachB: "h",
        pairs: [
    ...
    "f-v": {
        ...
        subtitle: "Fan or Van?",
        labelJa: "無声音と有声音(F/V)",
        theme: "text-rose-500", bgTheme: "bg-rose-50",
        coachA: "f", coachB: "v",
        pairs: [
    ...
    "p-f": {
        id: "p-f",
        title: "P / F",
        subtitle: "Pool or Fool?",
        labelJa: "PとFの聞き分け",
        theme: "text-fuchsia-600", bgTheme: "bg-fuchsia-50",
        coachA: "p", coachB: "f",
        pairs: [
    ...
    "w-v": {
        id: "w-v",
        title: "W / V",
        subtitle: "West or Vest?",
        labelJa: "WとVの聞き分け",
        theme: "text-cyan-600", bgTheme: "bg-cyan-50",
        coachA: "w", coachB: "v",
        pairs: [
    ...
    "i-ee": {
        id: "i-ee",
        title: "I / EE",
        subtitle: "Hit or Heat?",
        labelJa: "短いイ・長いイー",
        theme: "text-fuchsia-500", bgTheme: "bg-fuchsia-50",
        coachA: "i_short", coachB: "i_long",
        pairs: [
    ...
    "e-a": {
        ...
        subtitle: "Bed or Bad?",
        labelJa: "エとア (ɛ / æ)",
        theme: "text-purple-600", bgTheme: "bg-purple-50",
        coachA: "e", coachB: "a_ae",
        pairs: [
    ...
    "u-oo": {
        id: "u-oo",
        title: "U / OO",
        subtitle: "Pull or Pool?",
        labelJa: "ウとウー (ʊ / u:)",
        theme: "text-cyan-600", bgTheme: "bg-cyan-50",
        coachA: "u_short", coachB: "u_long",
        pairs: [
    ...
    "aw-ow": {
        id: "aw-ow",
        title: "AW / OW",
        subtitle: "Bought or Boat?",
        labelJa: "オーとオウ",
        theme: "text-orange-500", bgTheme: "bg-orange-50",
        coachA: "aw", coachB: "ow",
        pairs: [

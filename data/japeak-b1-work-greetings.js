...
function addB1WorkGreetingsRuby(text) {
    const rubyMap = {
        "打ち合わせ日": "うちあわせび",
    ...
    return text.replace(pattern, matched => {
        return `<ruby>${matched}<rt>${rubyMap[matched]}</rt></ruby>`;
    });
}

function b1WGLine(label, key, name, line, target, romaji) {
    return {
        label,
        key,
        name,
        line,
        target,
        ruby: addB1WorkGreetingsRuby(line),
        romaji
    };
}
...
const japeakB1WorkGreetingsData = [
    ...
    makeB1WorkGreetingsDialogue(
        ...
        "朝、職場であいさつする",
        [
            b1WGLine("話者B", "worker", "社員", "おはようございます。本日もよろしくお願いします。", "おはようございます ほんじつもよろしくおねがいします", "Ohayō gozaimasu. Honjitsu mo yoroshiku onegai shimasu."),
            b1WGLine("話者A", "senior", "先輩", "おはようございます。昨日の作業は順調でしたか。", "おはようございます きのうのさぎょうはじゅんちょうでしたか", "Ohayō gozaimasu. Kinō no sagyō wa junchō deshita ka."),
            b1WGLine("話者B", "worker", "社員", "はい、大きな問題はありませんでした。ただ、最後の確認に少し時間がかかりました。", "はい おおきなもんだいはありませんでした ただ さいごのかくにんにすこしじかんがかかりました", "Hai, ōkina mondai wa arimasen deshita. Tada, saigo no kakunin ni sukoshi jikan ga kakarimashita."),
            b1WGLine("話者A", "senior", "先輩", "そうでしたか。確認に時間がかかった理由はありますか。", "そうでしたか かくにんにじかんがかかったりゆうはありますか", "Sō deshita ka. Kakunin ni jikan ga kakatta riyū wa arimasu ka."),
            b1WGLine("話者B", "worker", "社員", "部品の数が合っているか不安だったので、もう一度確認しました。", "ぶひんのかずがあっているかふあんだったので もういちどかくにんしました", "Buhin no kazu ga atte iru ka fuan datta node, mō ichido kakunin shimashita."),
            b1WGLine("話者A", "senior", "先輩", "それは大切ですね。今日も安全に、落ち着いて進めましょう。", "それはたいせつですね きょうもあんぜんに おちついてすすめましょう", "Sore wa taisetsu desu ne. Kyō mo anzen ni, ochitsuite susumemashō.")
        ],
        {
            ja: [
    ...
    makeB1WorkGreetingsDialogue(
        ...
        "初めて会う人にあいさつする",
        [
            b1WGLine("話者B", "worker", "社員", "はじめまして。本日からこちらで働くことになりました。", "はじめまして ほんじつからこちらではたらくことになりました", "Hajimemashite. Honjitsu kara kochira de hataraku koto ni narimashita."),
            b1WGLine("話者A", "supervisor", "上司", "はじめまして。お名前を教えていただけますか。", "はじめまして おなまえをおしえていただけますか", "Hajimemashite. Onamae o oshiete itadakemasu ka."),
            b1WGLine("話者B", "worker", "社員", "山田マリアと申します。どうぞよろしくお願いいたします。", "やまだまりあともうします どうぞよろしくおねがいいたします", "Yamada Maria to mōshimasu. Dōzo yoroshiku onegai itashimasu."),
            b1WGLine("話者A", "supervisor", "上司", "こちらこそ、よろしくお願いします。前の職場ではどんな仕事をしていましたか。", "こちらこそ よろしくおねがいします まえのしょくばではどんなしごとをしていましたか", "Kochira koso, yoroshiku onegai shimasu. Mae no shokuba de wa donna shigoto o shite imashita ka."),
            b1WGLine("話者B", "worker", "社員", "工場で商品の検査をしていました。細かい確認作業には慣れています。", "こうじょうでしょうひんのけんさをしていました こまかいかくにんさぎょうにはなれています", "Kōjō de shōhin no kensa o shite imashita. Komakai kakunin sagyō ni wa narete imasu."),
            b1WGLine("話者A", "supervisor", "上司", "わかりました。最初は先輩と一緒に作業するので、安心してください。", "わかりました さいしょはせんぱいといっしょにさぎょうするので あんしんしてください", "Wakarimashita. Saisho wa senpai to issho ni sagyō suru node, anshin shite kudasai.")
        ],
        {
            ja: [
    ...
    makeB1WorkGreetingsDialogue(
        ...
        "久しぶりに会った同僚に声をかける",
        [
            b1WGLine("話者B", "worker", "社員", "お久しぶりです。しばらく別の部署にいらっしゃいましたよね。", "おひさしぶりです しばらくべつのぶしょにいらっしゃいましたよね", "Ohisashiburi desu. Shibaraku betsu no busho ni irasshaimashita yo ne."),
            b1WGLine("話者A", "colleague", "同僚", "はい、先週まで応援に行っていました。", "はい せんしゅうまでおうえんにいっていました", "Hai, senshū made ōen ni itte imashita."),
            b1WGLine("話者B", "worker", "社員", "お疲れさまでした。向こうの仕事は大変でしたか。", "おつかれさまでした むこうのしごとはたいへんでしたか", "Otsukaresama deshita. Mukō no shigoto wa taihen deshita ka."),
            b1WGLine("話者A", "colleague", "同僚", "少し忙しかったですが、仕事の流れを学ぶいい機会になりました。", "すこしいそがしかったですが しごとのながれをまなぶいいきかいになりました", "Sukoshi isogashikatta desu ga, shigoto no nagare o manabu ii kikai ni narimashita."),
            b1WGLine("話者B", "worker", "社員", "それはよかったですね。こちらでも何か変わったことがあれば共有します。", "それはよかったですね こちらでもなにかかわったことがあればきょうゆうします", "Sore wa yokatta desu ne. Kochira demo nanika kawatta koto ga areba kyōyū shimasu."),
            b1WGLine("話者A", "colleague", "同僚", "ありがとうございます。久しぶりなので、あとで少し教えてください。", "ありがとうございます ひさしぶりなので あとですこしおしえてください", "Arigatō gozaimasu. Hisashiburi na node, ato de sukoshi oshiete kudasai.")
        ],
        {
            ja: [
    ...
    makeB1WorkGreetingsDialogue(
        ...
        "体調を気づかう",
        [
            b1WGLine("話者B", "worker", "社員", "昨日は体調が悪いと聞きました。もう大丈夫ですか。", "きのうはたいちょうがわるいとききました もうだいじょうぶですか", "Kinō wa taichō ga warui to kikimashita. Mō daijōbu desu ka."),
            b1WGLine("話者A", "colleague", "同僚", "ありがとうございます。薬を飲んで、だいぶよくなりました。", "ありがとうございます くすりをのんで だいぶよくなりました", "Arigatō gozaimasu. Kusuri o nonde, daibu yoku narimashita."),
            b1WGLine("話者B", "worker", "社員", "それなら安心しました。でも、無理しすぎないでくださいね。", "それならあんしんしました でも むりしすぎないでくださいね", "Sore nara anshin shimashita. Demo, muri shisuginaide kudasai ne."),
            b1WGLine("話者A", "colleague", "同僚", "はい。今日は様子を見ながら、ゆっくり作業します。", "はい きょうはようすをみながら ゆっくりさぎょうします", "Hai. Kyō wa yōsu o minagara, yukkuri sagyō shimasu."),
            b1WGLine("話者B", "worker", "社員", "重い物を運ぶ作業があれば、私も手伝います。", "おもいものをはこぶさぎょうがあれば わたしもてつだいます", "Omoi mono o hakobu sagyō ga areba, watashi mo tetsudaimasu."),
            b1WGLine("話者A", "colleague", "同僚", "助かります。必要なときは遠慮なく声をかけます。", "たすかります ひつようなときはえんりょなくこえをかけます", "Tasukarimasu. Hitsuyō na toki wa enryo naku koe o kakemasu.")
        ],
        {
            ja: [
    ...
    makeB1WorkGreetingsDialogue(
        ...
        "外出するときのあいさつ",
        [
            b1WGLine("話者B", "worker", "社員", "すみません。これから取引先へ行ってまいります。", "すみません これからとりひきさきへいってまいります", "Sumimasen. Kore kara torihikisaki e itte mairimasu."),
            b1WGLine("話者A", "supervisor", "上司", "わかりました。今日はどのような用件ですか。", "わかりました きょうはどのようなようけんですか", "Wakarimashita. Kyō wa dono yō na yōken desu ka."),
            b1WGLine("話者B", "worker", "社員", "新しい資料を渡して、次回の打ち合わせ日を確認する予定です。", "あたらしいしりょうをわたして じかいのうちあわせびをかくにんするよていです", "Atarashii shiryō o watashite, jikai no uchiawasebi o kakunin suru yotei desu."),
            b1WGLine("話者A", "supervisor", "上司", "戻る時間は何時ごろになりそうですか。", "もどるじかんはなんじごろになりそうですか", "Modoru jikan wa nanji goro ni narisō desu ka."),
            b1WGLine("話者B", "worker", "社員", "三時半ごろには戻れると思いますが、遅れる場合は連絡します。", "さんじはんごろにはもどれるとおもいますが おくれるばあいはれんらくします", "San-ji han goro ni wa modoreru to omoimasu ga, okureru baai wa renraku shimasu."),
            b1WGLine("話者A", "supervisor", "上司", "お願いします。気をつけて行ってきてください。", "おねがいします きをつけていってきてください", "Onegai shimasu. Ki o tsukete itte kite kudasai.")
        ],
        {
            ja: [
    ...
    makeB1WorkGreetingsDialogue(
        ...
        "戻ってきたときのあいさつ",
        [
            b1WGLine("話者B", "worker", "社員", "ただいま戻りました。", "ただいまもどりました", "Tadaima modorimashita."),
            b1WGLine("話者A", "supervisor", "上司", "お疲れさまでした。先方との話はどうでしたか。", "おつかれさまでした せんぽうとのはなしはどうでしたか", "Otsukaresama deshita. Senpō to no hanashi wa dō deshita ka."),
            b1WGLine("話者B", "worker", "社員", "大きな問題はなく、次回の予定も決まりました。", "おおきなもんだいはなく じかいのよていもきまりました", "Ōkina mondai wa naku, jikai no yotei mo kimarimashita."),
            b1WGLine("話者A", "supervisor", "上司", "それはよかったです。何か追加で確認することはありますか。", "それはよかったです なにかついかでかくにんすることはありますか", "Sore wa yokatta desu. Nanika tsuika de kakunin suru koto wa arimasu ka."),
            b1WGLine("話者B", "worker", "社員", "資料の一部を修正してほしいと言われました。あとで内容をまとめます。", "しりょうのいちぶをしゅうせいしてほしいといわれました あとでないようをまとめます", "Shiryō no ichibu o shūsei shite hoshii to iwaremashita. Ato de naiyō o matomemasu."),
            b1WGLine("話者A", "supervisor", "上司", "お願いします。共有してもらえれば、こちらでも確認します。", "おねがいします きょうゆうしてもらえれば こちらでもかくにんします", "Onegai shimasu. Kyōyū shite moraereba, kochira demo kakunin shimasu.")
        ],
        {
            ja: [
                "社員：ただいま戻りました。",
    ...
    makeB1WorkGreetingsDialogue(
        ...
        "先に退勤するときのあいさつ",
        [
            b1WGLine("話者B", "worker", "社員", "お先に失礼します。本日もありがとうございました。", "おさきにしつれいします ほんじつもありがとうございました", "Osaki ni shitsurei shimasu. Honjitsu mo arigatō gozaimashita."),
            b1WGLine("話者A", "senior", "先輩", "お疲れさまでした。今日の作業は全部終わりましたか。", "おつかれさまでした きょうのさぎょうはぜんぶおわりましたか", "Otsukaresama deshita. Kyō no sagyō wa zenbu owarimashita ka."),
            b1WGLine("話者B", "worker", "社員", "はい、予定していた作業は終わりました。引き継ぎのメモも残してあります。", "はい よていしていたさぎょうはおわりました ひきつぎのめもものこしてあります", "Hai, yotei shite ita sagyō wa owarimashita. Hikitsugi no memo mo nokoshite arimasu."),
            b1WGLine("話者A", "senior", "先輩", "ありがとうございます。明日の準備で気になることはありますか。", "ありがとうございます あしたのじゅんびできになることはありますか", "Arigatō gozaimasu. Ashita no junbi de ki ni naru koto wa arimasu ka."),
            b1WGLine("話者B", "worker", "社員", "材料が少なくなっていたので、発注が必要かもしれません。", "ざいりょうがすくなくなっていたので はっちゅうがひつようかもしれません", "Zairyō ga sukunaku natte ita node, hatchū ga hitsuyō kamoshiremasen."),
            b1WGLine("話者A", "senior", "先輩", "わかりました。こちらで確認しておきます。気をつけて帰ってください。", "わかりました こちらでかくにんしておきます きをつけてかえってください", "Wakarimashita. Kochira de kakunin shite okimasu. Ki o tsukete kaette kudasai.")
        ],
        {
            ja: [
    ...
    makeB1WorkGreetingsDialogue(
        ...
        "一日の終わりに感謝を伝える",
        [
            b1WGLine("話者B", "worker", "社員", "今日は作業を教えていただき、ありがとうございました。", "きょうはさぎょうをおしえていただき ありがとうございました", "Kyō wa sagyō o oshiete itadaki, arigatō gozaimashita."),
            b1WGLine("話者A", "senior", "先輩", "どういたしまして。少しずつ慣れていけば大丈夫です。", "どういたしまして すこしずつなれていけばだいじょうぶです", "Dō itashimashite. Sukoshi zutsu narete ikeba daijōbu desu."),
            b1WGLine("話者B", "worker", "社員", "まだスピードは遅いですが、確認しながら進めたいと思います。", "まだすぴーどはおそいですが かくにんしながらすすめたいとおもいます", "Mada supīdo wa osoi desu ga, kakunin shinagara susumetai to omoimasu."),
            b1WGLine("話者A", "senior", "先輩", "最初は正確さの方が大切です。急がなくても大丈夫ですよ。", "さいしょはせいかくさのほうがたいせつです いそがなくてもだいじょうぶですよ", "Saisho wa seikakusa no hō ga taisetsu desu. Isoganakute mo daijōbu desu yo."),
            b1WGLine("話者B", "worker", "社員", "ありがとうございます。明日もわからないことがあれば質問します。", "ありがとうございます あしたもわからないことがあればしつもんします", "Arigatō gozaimasu. Ashita mo wakaranai koto ga areba shitsumon shimasu."),
            b1WGLine("話者A", "senior", "先輩", "はい、遠慮なく聞いてください。明日もよろしくお願いします。", "はい えんりょなくきいてください あしたもよろしくおねがいします", "Hai, enryo naku kiite kudasai. Ashita mo yoroshiku onegai shimasu.")
        ],
        {
            ja: [
